from run_alltrain import run_func
...
encoder_config = {
    "n_hidden_1": 1500,  # first layer nodes num
    "n_hidden_2": 500,   # second layer nodes num
    "L2_reg": 1e-5,
    "L1_reg": 1e-5,
    "loss_alpha": 0,   # use for encoder warm up
    "loss_alpha2": 1,  # rate for loss function
    "dropout": 0,
    "warm_up_epoch": 0
}
nn_config = {
...
save_idf = "alltrain"     #identify for model
save_idf += ablation
...
# #
# hidden_l1list = [2000, 1500, 1000]
# hidden_l2list = [500, 400, 200]
# node_numlist = [50, 40, 30, 20, 10]
